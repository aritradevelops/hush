...
import { Lock, Eye, EyeOff, Mail, User, ArrowLeft } from "lucide-react"
...
import { getGoogleOauthUrl } from "@/lib/oauth-helper"
...
function LoginForm() {
  ...
  const { isSubmitting, form, fields } = useForm({
    ...
    onSubmit: async function (data) {
      const result = await httpClient.signIn(data)
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <PasswordInput id={fields.password.id} placeholder="Enter your password" className="pl-8" />
            </div>
            {
          ...
          <div className="space-y-2 flex flex-row-reverse">
            <Link href={"/forgot-password"} className="font-medium text-sm text-primary hover:underline"> Forgot Password ?</Link>
          </div>
          {
